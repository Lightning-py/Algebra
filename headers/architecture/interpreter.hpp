...
namespace arch
{
    class Interpreter
    {
        public:
            ...
            auto handler(libs::line_type key, libs::lines_type) -> void;
        ...
        private:
            ...
            auto plus(const elements_type_ &commandElements) -> void;
            auto fout(const elements_type_ &commandElements) -> void;
